...
return {
  ...
  { import = "astrocommunity.code-runner.molten-nvim" }, -- Jupyter-style outputs

  -- Markdown/Diagramme (PlantUML läuft oft via preview)
  ...
  -- { import = "astrocommunity.init.lua" },
  ...
  -- { import = "astrocommunity.workflow.precognition-nvim" }, { import = "astrocommunity.colorscheme.catppuccin" },
}
